...
from .views import property_create, property_list, property_detail, property_update, unit_create, unit_list, unit_detail, unit_edit, unit_create
...
urlpatterns = [
    ...
    path('unit/<int:pk>/edit/', unit_edit, name='unit_edit'),
